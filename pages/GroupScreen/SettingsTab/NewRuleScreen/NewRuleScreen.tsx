    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                <TextInput mode='outlined' onChangeText={handleNewRuleUpdate} label="Rule" maxLength={75}  outlineColor={colors.white} placeholder="Rule..." activeOutlineColor={colors.white} value={newRule} />
